...
//Continous scrolling effect 
const wrapper = document.querySelector('.content-carrousel');
const items = document.querySelectorAll('.shadow');
...
function moveToNext() {
  ...
  if (currentIndex >= itemCount) {
    ...
    }, 50); // Adjust the delay to ensure the transition is re-enabled
  }
  wrapper.style.transform = `translateX(-${currentIndex * itemWidth}px)`;
}

setInterval(moveToNext, 3000); // Adjust the interval as needed
